...
if(LIST_OF_SANITIZERS)
    if(NOT "${LIST_OF_SANITIZERS}" STREQUAL "")
        target_compile_options(common_project_options INTERFACE -fsanitize=${LIST_OF_SANITIZERS})
        target_link_options(common_project_options INTERFACE -fsanitize=${LIST_OF_SANITIZERS})
    endif()
endif()
